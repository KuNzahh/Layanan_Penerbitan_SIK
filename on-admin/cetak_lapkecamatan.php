...
class PDF extends FPDF
{
    ...
    function Body($data, $total, $filterMonth)
    {
        ...
        $this->Cell(0, 10, 'LAPORAN JUMLAH SIK BERDASARKAN KECAMATAN', 0, 1, 'C');
        $this->SetFont('Arial', '', 10);
        $this->Cell(0, 0, '', 'T', 0, 'L');
        ...
        $this->MultiCell(0, 10, "Laporan ini menyajikan jumlah Surat Izin Keramaian (SIK) yang diterbitkan berdasarkan kecamatan.", 0, 'J');
        $this->Ln(2);
        ...
        $this->Cell(90, 10, 'Kecamatan', 1, 0, 'C', true);
        ...
        foreach ($data as $index => $row) {
            ...
            $this->Cell(90, 10, $row['nm_kecamatan'], 1, 0, 'L');
        ...
        $this->Ln(20); // Jarak dari tabel ke bagian footer
        $this->SetFont('Arial', '', 11);
